...
var _a = require('./api/database'), dbPool = _a.mysqlPool, testConnection = _a.testMySQLConnection;
function migrateLearnerTracking() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    error_1 = _a.sent();
                    console.error('Learner tracking migration failed:', error_1);
                    return [3 /*break*/, 8];
