...
class DataProcessor {
     ...
     */
    async processModuleFile(filename) {
        try {
     ...
     */
    async processTextContent(module) {
        ...
        if (module.language === 'am') {
            ...
            module.translated_text = `English translation of: ${(_a = module.source_body) === null || _a === void 0 ? void 0 : _a.substring(0, 100)}...`;
        }
        else {
            // For English content, set translated_text and generate Amharic "translation"
            module.translated_text = module.source_body;
            // In a real implementation, this would call a translation API
            module.original_text = `Amharic translation of: ${(_b = module.source_body) === null || _b === void 0 ? void 0 : _b.substring(0, 100)}...`;
        }
    }
    /**
     * Convert legacy steps to workflow format
     */
    convertStepsToWorkflows(steps) {
     ...
     */
    generateModuleId(module) {
        var _a;
        const title = module.title || module.topic || module.module || 'unknown';
        return `${((_a = module.category) === null || _a === void 0 ? void 0 : _a.toLowerCase()) || 'general'}-${title.toLowerCase().replace(/\s+/g, '-')}-${Date.now()}`;
    }
    /**
