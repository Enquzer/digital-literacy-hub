...
var CustomsCommissionScraper = /** @class */ (function (_super) {
    __extends(CustomsCommissionScraper, _super);
    function CustomsCommissionScraper() {
        return _super.call(this, 'https://ecc.gov.et', 'customs-commission') || this;
    }
    CustomsCommissionScraper.prototype.scrape = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modules, eSWModule, eTradeModule, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, this.scrapeESWSystem()];
                    case 2:
                        eSWModule = _a.sent();
                        if (eSWModule)
                    ...
                    case 4:
                        error_1 = _a.sent();
                        console.error('Error scraping Customs Commission data:', error_1);
                        return [2 /*return*/, []];
    ...
    CustomsCommissionScraper.prototype.scrapeESWSystem = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_2 = _a.sent();
                        console.error('Error scraping e-SW system data:', error_2);
    ...
    CustomsCommissionScraper.prototype.scrapeETradePortal = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_3 = _a.sent();
                        console.error('Error scraping eTrade portal data:', error_3);
                        return [2 /*return*/, null];
                    case 3: return [2 /*return*/];
                }
            });
    ...
    return CustomsCommissionScraper;
