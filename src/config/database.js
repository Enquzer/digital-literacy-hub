...
export async function getUserById(userId) {
  ...
  console.log('getUserById is now handled by the API client');
  return null;
}

export async function getCourses(isPublished = true) {
  // This is now handled by the API client
  console.log('getCourses is now handled by the API client');
  return [];
}
